...
///
/// This struct serializes an `Instant` into a i64 which is the number of
/// non-leap-nanoseconds since January 1, 1970 UTC.
///
/// Note: Serialization and deserialization are not perfectly accurate and can
...
mod serde_impl {
    ...
    where I: Instant
    {
        ...
        where S: Serializer {
            ...
            let nano = datetime
                .timestamp_nanos_opt()
                .ok_or(serde::ser::Error::custom("time out of range"))?;
    ...
    mod tests {
        ...
        use super::SerdeInstant;
        use crate::async_runtime::instant::TokioInstant;
